        ...
        <div className="auth-page">
            ...
            <div className="auth-container">
                ...
                <form onSubmit={handleSubmit} className="auth-form">
                    ...
                    <div className="auth-field">
                        ...
                        <input
                            ...
                            type="text"
                            value={nomComplet}
                            onChange={(e: ChangeEvent<HTMLInputElement>) => setNomComplet(e.target.value)}
                ...
                <div className="auth-social-buttons">
                    <button type="button" onClick={() => signInWithOAuth('google' as Provider)} className="auth-social-btn" aria-label="S'inscrire avec Google">
                    ...
                    <button type="button" onClick={() => signInWithOAuth('facebook' as Provider)} className="auth-social-btn" aria-label="S'inscrire avec Facebook">
                        <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button type="button" onClick={() => signInWithOAuth('apple' as Provider)} className="auth-social-btn" aria-label="S'inscrire avec Apple">
                        <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
